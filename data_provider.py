...
def data_provider(dataset, root, batch_size, n_threads=4, download=False):
    ...
    print(len(trainset))
    db_train, db_val = torch.utils.data.random_split(trainset, [40000, 10000])
    db_trainloader = torch.utils.data.DataLoader(db_train,
                                                 batch_size=batch_size,
                                                 shuffle=True,
                                                 pin_memory=True,
                                                 num_workers=n_threads)

    db_valloader = torch.utils.data.DataLoader(db_val,
                                               batch_size=batch_size,
                                               shuffle=True,
                                               pin_memory=True,
                                               num_workers=n_threads)
    ...
    return trainloader, testloader, db_trainloader, db_valloader
